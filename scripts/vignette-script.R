...
dataset <- read.csv("/Users/pierotrujillo/Downloads/PSTAT 197/group 3/vignette-sentiment-analysis/data/IMDB-raw.csv")
...
dataset <- dataset_clean %>%
  select(c(.id, length, afinn_score, nrc_score, bing_score, loughran_score, sentiment))
